      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="relative mb-8">
          ...
          <div className="w-24 h-24 rounded-2xl cobalt-gradient flex items-center justify-center relative shadow-2xl overflow-hidden group">
            <div className="absolute inset-0 bg-white/20 animate-ping group-hover:bg-blue-400/20" />
        ...
        <div className="flex gap-2 animate-pulse">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="w-2 h-2 rounded-full bg-blue-400" style={{ animationDelay: `${i * 0.2}s` }}></div>
          ))}
        </div>
      </div>
